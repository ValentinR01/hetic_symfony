 ...
 */
final class Version20221025122009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, deal_id INT DEFAULT NULL, user_id INT NOT NULL, date_creation DATETIME NOT NULL, parent_id INT DEFAULT NULL, content LONGTEXT NOT NULL, INDEX IDX_9474526CF60E2305 (deal_id), INDEX IDX_9474526CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE deal (id INT AUTO_INCREMENT NOT NULL, seller_id INT NOT NULL, buyer_id INT DEFAULT NULL, category_id INT NOT NULL, product_state_id INT NOT NULL, price INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, photo VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_publication DATETIME DEFAULT NULL, date_update DATETIME DEFAULT NULL, is_sold TINYINT(1) NOT NULL, is_published TINYINT(1) NOT NULL, date_purchase DATETIME DEFAULT NULL, INDEX IDX_E3FEC1168DE820D9 (seller_id), INDEX IDX_E3FEC1166C755722 (buyer_id), INDEX IDX_E3FEC11612469DE2 (category_id), INDEX IDX_E3FEC116CE685656 (product_state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(30) NOT NULL, email VARCHAR(255) NOT NULL, nb_user_likes INT DEFAULT NULL, nb_user_dislikes INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, bought_other_users_pseudo LONGTEXT DEFAULT NULL, bought_other_users_id LONGTEXT DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
